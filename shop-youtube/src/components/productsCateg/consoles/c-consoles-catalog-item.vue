  ...
  <div class='c-consoles-item'>
    ...
    >
      ...
      <div>
        ...
        <p class="c-consoles-item__name">Article: {{product_data.article}}</p>
        <p class="c-consoles-item__price">Price: {{product_data.price | toFix}} Р.</p>
        <p class="c-consoles-item__price">Category: {{product_data.category}}</p>
