  ...
  <div class='g-garden-item'>
    ...
    >
      ...
      <div>
        ...
        <p class="g-garden-item__name">Article: {{product_data.article}}</p>
        <p class="g-garden-item__price">Price: {{product_data.price | toFix}} Р.</p>
        <p class="g-garden-item__price">Category: {{product_data.category}}</p>
